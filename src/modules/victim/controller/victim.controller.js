...
export const setEmergencyContacts = async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ message: "Emergency contacts updated successfully.", victim });
};
...
export const setHeartAndLocation = async (req, res) => {
  ...
  res
    .status(200)
    .json({ message: "Heart rate and location updated successfully.", victim });
};
...
export const sendSOSMessage = async (req, res) => {
  ...
  res
    .status(200)
    .json({ message: "SOS message sent to all emergency contacts.", victim });
};
